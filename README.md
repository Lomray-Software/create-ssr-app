...
| `cloudflare`     | [`example/cloudflare`](https://github.com/Lomray-Software/vite-template/tree/example/cloudflare)         | The minimal app deployed to Cloudflare Workers: a Worker entry, Workers Static Assets, a KV binding read in a loader, wrangler preview and deploy                                                    |
